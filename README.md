...
```
var result = wh_api.createRecipe(account_id, options);
```
#####Parameters
...
```
var result = wh_api.updateRecipe(account_id, recipe_id, options);
```
#####Parameters
...
```
var result = wh_api.publishRecipe(account_id, recipe_id, options);
```
#####Parameters
...
```
var result = wh_api.getRecipe(account_id, recipe_id, options);
```
#####Parameters
...
```
var result = wh_api.getRecipes(account_id, options);
```
#####Parameters
...
```
var result = wh_api.deleteRecipe(account_id, recipe_id, options);
```
#####Parameters
...
```
var result = wh_api.testRecipe(account_id, options);
```
#####Parameters
